...
7. Дополнительное задание: Статистика
   ...
   Created
   до Merged PullRequest) `/statistics/user` и статистики по команде (среднее время по всем PullRequest команды, и список статистики
   каждого члена команды) `/statistics/team`
